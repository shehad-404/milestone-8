...
5.	UserDetails.jsx:
    o	Gets userId via useParams().
    o	Uses useLoaderData() to get full flower array.
    o	Finds the flower object with matching id.
    o	Displays image, name, description, like count.
    o	Provides a “Back to Home” link.
